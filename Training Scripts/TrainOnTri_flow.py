...
torch.save(RModel.state_dict(),f"cnnFLOW_TR_100.pth")
...
for nts in [100,200,300]:
    ...
    torch.save(RModel.state_dict(),f"cnnFLOW_TR_r{nts}.pth")
...
for nts in [100,200,300]:
    ...
    torch.save(RModel.state_dict(),f"cnnFLOW_TR_{nts}.pth")
...
# save Model
torch.save(RModel.state_dict(),f"cnnFLOW_TR_OUT.pth")
