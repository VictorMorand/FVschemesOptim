...
TrainSet = GenerateGrRiemannTrainingSet(**args,plot=False,save=True)
...
torch.save(RModel.state_dict(),f"cnnSPEED_100.pth")
...
for nts in [100,200,300]:
    ...
    torch.save(RModel.state_dict(),f"cnnSPEED_r{nts}.pth")
...
for nts in [100,200,300]:
    ...
    torch.save(RModel.state_dict(),f"cnnSPEED_{nts}.pth")
...
# save Model
torch.save(RModel.state_dict(),f"cnnSPEED_OUT.pth")
